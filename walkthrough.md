...
### 🛠️ Building the APK (Manual)
If you want to build the APK file to transfer to your phone:
```bash
cd /home/sam/Documents/antigrav_mobile/app
flutter build apk --debug
```
The file will be at: `app/build/app/outputs/flutter-apk/app-debug.apk`
